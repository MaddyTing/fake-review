    ...
    public static String fakeReview(String fileName)
    {
        ...
        for(int i = 0; i < file.length(); i++)
        {
            if(file.substring(i, i+1).equals(" "))
            {
                ...
                {
                    endingPunctuation = getPunctuation(temp);
                    randomAdj = randomAdjective();
        ...
        fakeReview = fakeReview.substring(0, fakeReview.length() - 1);

        return fakeReview;
    }

    public static String slantReview(String fileName)
        {
        String file = textToString(fileName) + " ";
        String fakeReview = "";
        String temp = "";
